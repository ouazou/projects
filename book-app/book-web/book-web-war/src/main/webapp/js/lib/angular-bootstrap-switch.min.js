...
"use strict";
angular.module("frapontillo.bootstrap-switch", []), angular.module("frapontillo.bootstrap-switch").directive("bsSwitch", ["$timeout", function(a) {
        return{restrict: "EA", require: "ngModel", scope: {switchActive: "@", switchOnText: "@", switchOffText: "@", switchOnColor: "@", switchOffColor: "@", switchAnimate: "@", switchSize: "@", switchLabel: "@", switchIcon: "@", switchWrapper: "@"}, template: function(a) {
